...
const PLAN_DEFINITIONS: Record<BillingPlanId, PlanDefinition> = {
  capture: {
    ...
    trialDays: 14,
    highlight: 'Full workspace access with a smaller user and document allowance',
  },
  control: {
    id: 'control',
    label: 'Control',
    ...
    trialDays: 14,
    highlight: 'Full workspace access with a growing user and document allowance',
  },
  operations: {
    id: 'operations',
    label: 'Operations',
    ...
    trialDays: 14,
    highlight: 'Full workspace access with a larger user and document allowance',
  },
  enterprise: {
    id: 'enterprise',
    label: 'Enterprise',
