...
CREATE TABLE IF NOT EXISTS organisations (
  ...
  billing_period_started_at TIMESTAMP NULL DEFAULT NULL,
...
ALTER TABLE organisations
  ...
  ADD COLUMN IF NOT EXISTS billing_period_started_at TIMESTAMP NULL DEFAULT NULL AFTER trial_ends_at,
  ADD COLUMN IF NOT EXISTS billing_period_ends_at TIMESTAMP NULL DEFAULT NULL AFTER billing_period_started_at,
  ADD COLUMN IF NOT EXISTS monthly_document_limit INT NULL DEFAULT NULL AFTER billing_period_ends_at,
